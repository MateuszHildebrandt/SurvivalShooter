...
[CustomPropertyDrawer(typeof(IfHideAttribute))]
public class IfHideDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {

        IfHideAttribute condHAtt = (IfHideAttribute)attribute;
    ...
    private bool GetConditionalHideAttributeResult(IfHideAttribute condHAtt, SerializedProperty property)
    {
